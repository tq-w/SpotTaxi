...
public class RedisConstant {
    ...
    public static final int USER_LOGIN_KEY_TIMEOUT = 60 * 60 * 24; // 单位要用秒
...
//    public static final long ORDER_JOB_EXPIRES_TIME = 15;
    ...
    //抢新订单锁
    public static final String TAKE_NEW_ORDER_LOCK = "order:take:lock";
    public static final String ORDER_STOCK_KEY = "order:stock:";
    //等待获取锁的时间
    public static final long TAKE_NEW_ORDER_LOCK_WAIT_TIME = 1;
    //加锁的时间
    public static final long TAKE_NEW_ORDER_LOCK_LEASE_TIME = 1;
    ...
    //假装支付
    public static final String PAYMENT_FAKE_MARK = "payment:fake:mark:";
}
