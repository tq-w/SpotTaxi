package com.spot.taxi.model.entity.order;
...
public class OrderBill extends BaseEntity {
	...
	private BigDecimal payAmount; //todo未添加

    @Schema(description = "里程费")
	@TableField("distance_fee")
	private BigDecimal distanceFee; //todo未添加

    @Schema(description = "等时费用")
	@TableField("wait_fee")
	private BigDecimal waitFee; //todo未添加
	...
	private BigDecimal longDistanceFee;  //todo未添加
	...
	private BigDecimal rewardFee;  //todo未添加
	...
	private BigDecimal couponAmount;  //todo未添加
